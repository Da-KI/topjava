...
public class ExceptionInfoHandler {
    ...
    // https://stackoverflow.com/a/42422568/548473
    ...
    public ErrorInfo bindValidationException(HttpServletRequest req, BindException e) {
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String... details) {
        ...
        return new ErrorInfo(req.getRequestURL(), errorType, details.length != 0 ? Arrays.toString(details) : rootCause.getMessage());
    }
